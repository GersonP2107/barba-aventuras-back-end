"use strict";
/* build-hook-start *//*00001*/try { require('c:\\Users\\gerso\\.vscode\\extensions\\wallabyjs.console-ninja-1.0.448\\out\\buildHook\\index.js').default({tool: 'nest.js', checkSum: '2006ebe450d0da8fcfce4eAQdLUksCDwhQCVBWCVFUBVEDAwQF', mode: 'runtime'}); } catch(cjsError) { try { import('file:///c:/Users/gerso/.vscode/extensions/wallabyjs.console-ninja-1.0.448/out/buildHook/index.js').then(m => m.default.default({tool: 'nest.js', checkSum: '2006ebe450d0da8fcfce4eAQdLUksCDwhQCVBWCVFUBVEDAwQF', mode: 'runtime'})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */
